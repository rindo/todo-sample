...
var (
	todoDBTypes = map[string]string{`ID`: `integer`, `Name`: `character varying`, `Done`: `boolean`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
